...
const translations = {
  ...
  pt: {
    ...
    'sitter.petSittingRequest': 'Pedido de Pet Sitting',
    'sitter.petOwner': 'Dono do Animal',
    'sitter.decline': 'Recusar',
    'sitter.accept': 'Aceitar',
    'sitter.petSitting': 'Pet Sitting',
    'sitter.contactClient': 'Contactar Cliente',
    
    // Book Now
    'bookNow.title': 'Reserve o Seu Serviço Agora',
    'bookNow.subtitle': 'Escolha o seu serviço e sitter preferido para cuidado personalizado',
    'bookNow.fastBooking': 'Reserva Rápida',
    'bookNow.verifiedSitters': 'Sitters Verificados',
    'bookNow.support247': 'Suporte 24/7',
    'bookNow.serviceDetails': 'Detalhes do Serviço',
    'bookNow.selectServiceDescription': 'Selecione o seu serviço e sitter preferido para a melhor experiência',
    'bookNow.selectService': 'Selecionar Serviço',
    'bookNow.chooseService': 'Escolha o seu serviço',
    'bookNow.petServices': 'Serviços de Animais',
    'bookNow.houseServices': 'Serviços de Casa',
    'bookNow.combinedServices': 'Serviços Combinados',
    'bookNow.preferredSitter': 'Sitter Preferido (Opcional)',
    'bookNow.chooseSitter': 'Escolha um sitter ou deixe-nos atribuir um',
    'bookNow.letUsAssign': 'Deixe-nos atribuir o melhor sitter',
    'bookNow.verified': 'Verificado',
    'bookNow.startDate': 'Data de Início',
    'bookNow.endDate': 'Data de Fim',
    'bookNow.estimatedTotal': 'Total Estimado:',
    'bookNow.finalPriceConfirmed': '✓ Preço final confirmado após revisão admin',
    'bookNow.location': 'Localização',
    'bookNow.enterLocation': 'Introduza a sua localização (cidade, bairro)',
    'bookNow.contactPhone': 'Telefone de Contacto',
    'bookNow.yourPhone': 'O seu número de telefone',
    'bookNow.preferredContactTime': 'Hora de Contacto Preferida',
    'bookNow.whenContact': 'Quando podemos contactá-lo?',
    'bookNow.morning': 'Manhã (9h - 12h)',
    'bookNow.afternoon': 'Tarde (12h - 18h)',
    'bookNow.evening': 'Noite (18h - 21h)',
    'bookNow.anytime': 'Qualquer hora',
    'bookNow.petDetails': 'Detalhes dos Animais',
    'bookNow.tellAboutPets': 'Conte-nos sobre os seus animais',
    'bookNow.petName': 'Nome do Animal',
    'bookNow.breed': 'Raça',
    'bookNow.age': 'Idade',
    'bookNow.specialNeeds': 'Necessidades Especiais',
    'bookNow.addAnotherPet': 'Adicionar Outro Animal',
    'bookNow.removePet': 'Remover Animal',
    'bookNow.houseDetails': 'Detalhes da Casa',
    'bookNow.houseDetailsPlaceholder': 'Detalhes sobre a sua casa, acesso, alarmes, etc.',
    'bookNow.specialInstructions': 'Instruções Especiais',
    'bookNow.additionalInfo': 'Qualquer informação adicional que o sitter deva saber',
    'bookNow.requestBooking': 'Solicitar Reserva',
    'bookNow.signInToBook': 'Por favor entre para reservar um serviço',
    'bookNow.fillRequiredFields': 'Por favor preencha todos os campos obrigatórios',
    'bookNow.requestSubmitted': 'Pedido de reserva enviado! Vamos rever e confirmar em 24 horas.',
    'bookNow.failedToSubmit': 'Falha ao enviar pedido de reserva',
    'bookNow.failedToLoadServices': 'Falha ao carregar serviços',
    'bookNow.failedToLoadSitters': 'Falha ao carregar sitters',
    'bookNow.rating': 'avaliação',
  },
  es: {
    // Header
