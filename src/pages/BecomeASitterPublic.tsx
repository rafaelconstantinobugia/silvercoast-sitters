...
export const BecomeASitterPublic = () => {
    ...
    <Card>
      <CardContent className="p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          Thank you for your interest in becoming a SilverCoastSitters pet sitter. 
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> This is an application form only. You don't need to create an account. 
            Pet owners who want to book sitters will create accounts when they're ready to book.
          </p>
        </div>
