-- Insert sample services with correct enum values
INSERT INTO public.services (id, name, description, service_type, base_price, duration_hours, active) VALUES 
('00000000-0000-0000-0000-000000000001', 'Pet & House Sitting', 'Complete pet and house sitting service', 'combined', 35.00, 24, true),
('00000000-0000-0000-0000-000000000002', 'Professional Pet Sitting', 'Expert pet care with veterinary background', 'pet', 45.00, 24, true),
('00000000-0000-0000-0000-000000000003', 'House Sitting Service', 'Reliable home security and maintenance', 'house', 30.00, 24, true),
('00000000-0000-0000-0000-000000000004', 'Premium Pet & House Care', 'Top-tier complete care service', 'combined', 50.00, 24, true),
('00000000-0000-0000-0000-000000000005', 'Specialized Pet Care', 'Expert care for cats and small animals', 'pet', 40.00, 24, true),
('00000000-0000-0000-0000-000000000006', 'Complete Home Care', 'House and pet sitting with garden care', 'combined', 38.00, 24, true)
ON CONFLICT (id) DO NOTHING;

-- Insert sample sitters with proper UUIDs and corrected service types
